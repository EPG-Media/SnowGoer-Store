## SnowGoer Authorize.net WooCommerce E-Commerce Website Sandbox Details (credentials for sandbox dev environment ONLY)
...
<img src="./img/wp-live mode.png" width="70%">
